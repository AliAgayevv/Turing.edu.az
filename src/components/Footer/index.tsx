...
export default function Footer() {
  return (
    ...
    //   </div>
    // </div>
    <div className="fixed h-screen -z-[1]  bottom-0 bg-blue_ultraDark w-full text-white_lightMedium p-6 md:p-10 lg:px-20 lg:pt-16 flex flex-col lg:flex-row justify-between pointer-events-auto">
