  ...
  return (
    ...
    >
      ...
      <div className="h-[85px] w-full flex flex-col mt-4 gap-3">
        <button className="bg-white_ultraLight border-white_medium text-blue_lightMedium w-[59px] h-[26px] border rounded-lg px-[10px] py-1.5 flex justify-center items-center">
          {category}
        </button>
        <div>
