      ...
      <div className="absolute h-[700px] w-[1000px] translate-x-[-50%] translate-y-[-50%] left-[50%] top-[1100px]">
        <div>
          <img
            ...
            className="max-w-[237px] max-h-[323px] w-[237px] h-[323px] object-cover absolute lg:top-[70px] lg:left-[50px] top-[500px] left-[300px] rotate-on-cursor  -rotate-[15deg]"
          />
        </div>
        <div>
          <img
            src={animatedCardPhoto2}
            className="max-w-[260px] max-h-[354px] w-[260px] h-[354px] object-cover absolute lg:top-[50px] top-[500px] left-[560px] lg:left-[850px] rotate-on-cursor  rotate-[15deg]"
          />
        </div>
        <div>
          <img
