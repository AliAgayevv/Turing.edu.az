...
function FAQItem({ question, answer }) {
  ...
  return (
    <div className="w-[856px] p-4 h-auto rounded-lg border border-white_medium mb-4">
      <div
      ...
      {isVisible && (
        <p className="py-2 px-3 text-white_dark text-[14px] transition-all duration-300 w-5/6">
          {answer}
        </p>
      )}
    </div>
