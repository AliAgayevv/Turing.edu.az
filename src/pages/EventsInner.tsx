...
export default function EventsInner() {
  ...
  return (
    <div className="mx-auto w-11/12">
      <Navbar isDark={true} />
      <div className="mx-auto w-11/12 mt-5 md:mt-24 flex flex-col md:flex-row md:justify-between md:items-center">
        {/* Sol Kısım */}
      ...
      {currentEvent?.isEnd && (
        <div className="mt-24 w-11/12 mx-auto">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-10 lg:gap-5">
